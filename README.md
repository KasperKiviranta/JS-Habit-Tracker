Link to website https://kasperkiviranta.github.io/JS-Habit-Tracker/

# 🧩 Habit Tracker

A lightweight, client-side habit tracker built with **HTML, CSS, and JavaScript**.  
It runs fully in the browser using `localStorage` — no backend required.
...
- 7-day rolling view with streak counter
- Persistent data via `localStorage`
- Import / Export data as JSON
- Responsive and keyboard-accessible UI
- Dark mode design (no external frameworks)
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/KasperKiviranta/JS-Habit-Tracker.git

    Open the folder and double-click index.html.
    The tracker runs instantly in your default browser.
...
Open Finder → the project folder → right-click index.html → Open With → Safari/Chrome.
Alternatively:
